...
export default function ContactInfoCard({
    ...
    const contentProps = href ? { href, className: "text-gray-900 dark:text-white text-xl hover:text-gray-600 dark:hover:text-blue-400 transition-colors font-bold block" } : { className: "text-gray-900 dark:text-white text-lg font-medium" };
