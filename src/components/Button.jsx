...
const variants = {
    primary: [
        ...
        "hover:shadow-xl dark:shadow-blue-500/30 dark:hover:shadow-[0_0_15px_rgba(59,130,246,0.5)]",
...
export default function Button({
    ...
    const classes = [base, variants[variant] || variants.primary, widthClass, className].filter(Boolean).join(" ");
