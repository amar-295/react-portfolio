...
describe('TimelineItem component', () => {
    ...
    it.each([
        ['right', ['md:text-right', 'pr-0', 'md:pr-12', 'order-1'], ['pl-0', 'md:pl-12', 'order-3']],
        ['left', ['md:text-left', 'pl-0', 'md:pl-12', 'order-1', 'md:order-3'], ['pr-0', 'md:pr-12', 'order-3', 'md:order-1']]
    ])('applies correct classes for %s alignment layout', (side, dateClasses, cardClasses) => {
    ...
    it.each([
        ...
        render(<TimelineItem {...defaultProps} emoji="🎓" badge="B" badgeColor={color} />);
