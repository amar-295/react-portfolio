  ...
  return (
    <section
      ...
      <div className="container mx-auto px-6 grid md:grid-cols-12 gap-10 md:gap-16 items-center">
        <div className="md:col-span-8 space-y-8 text-center md:text-left order-1">
        ...
        <div className="md:col-span-4 relative flex justify-center items-center order-2 md:order-2 mt-8 md:mt-0">
